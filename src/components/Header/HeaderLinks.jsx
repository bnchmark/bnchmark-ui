...
class HeaderLinks extends React.Component {
    ...
    handleProfileClick = () => {
        this.setState({open_profile: !this.state.open_profile});
    };
    handleProfileClose = () => {
            ...
            <div className={wrapper}>
                ...
                {/*<Manager className={managerClasses}>
                    <Target>
                        ...
                        >
                            <Notifications
                                className={rtlActive ? classes.links + " " + classes.linksRTL : classes.links}/>
                ...
                <Manager className={managerClasses}>
                    <Target>
                        <IconButton
                            color="inherit"
                            aria-label="Person"
                            aria-owns={open_profile ? "profile-list" : null}
                            aria-haspopup="true"
                    ...
                    <Popper
                        placement="bottom-start"
                        eventsEnabled={open_profile}
                        className={
                            classNames({[classes.popperClose]: !open_profile}) +
                            " " +
                            classes.pooperResponsive
                        }
                    >
